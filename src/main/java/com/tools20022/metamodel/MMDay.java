...
/**
 * Any set of values drawn from the value space of 'gDay', as specified by W3C
 * Recommendation XML Schema Part 2: Datatypes.
 */
public class MMDay implements MMAbstractDateTimeConcept {
	...
	@Override
	public MetamodelType<? extends MMDay> getMetamodel() {
		return StandardMetamodel2013.metamodel().getTypeByClass(getClass());
	}

	public static MetamodelType<? extends MMDay> metaType() {
		return StandardMetamodel2013.metamodel().getTypeByClass(MMDay.class);
	}
