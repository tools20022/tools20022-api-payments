...
/**
 * documentation set showing relations between ISO 20022 MessageDefinitions,
 * MessageComponentTypes, MessageElements, BusinessComponents,
 * BusinessAssociations and/or BusinessElements and items defined in other
 * Industry MessageSets
 */
public class MMConvergenceDocumentation implements MMTopLevelCatalogueEntry {
	...
	@Override
	public MetamodelType<? extends MMConvergenceDocumentation> getMetamodel() {
		return StandardMetamodel2013.metamodel().getTypeByClass(getClass());
	}

	public static MetamodelType<? extends MMConvergenceDocumentation> metaType() {
		return StandardMetamodel2013.metamodel().getTypeByClass(MMConvergenceDocumentation.class);
	}
