...
/**
 * Any set of values drawn from the value space of 'gYear', as specified by W3C
 * Recommendation XML Schema Part 2: Datatypes.
 */
public class MMYear implements MMAbstractDateTimeConcept {
	...
	@Override
	public MetamodelType<? extends MMYear> getMetamodel() {
		return StandardMetamodel2013.metamodel().getTypeByClass(getClass());
	}

	public static MetamodelType<? extends MMYear> metaType() {
		return StandardMetamodel2013.metamodel().getTypeByClass(MMYear.class);
	}
