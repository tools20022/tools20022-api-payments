...
/**
 * Any set of values drawn from the value space of 'dateTime', as specified by
 * W3C Recommendation XML Schema Part 2: Datatypes.
 */
public class MMDateTime implements MMAbstractDateTimeConcept {
	...
	@Override
	public MetamodelType<? extends MMDateTime> getMetamodel() {
		return StandardMetamodel2013.metamodel().getTypeByClass(getClass());
	}

	public static MetamodelType<? extends MMDateTime> metaType() {
		return StandardMetamodel2013.metamodel().getTypeByClass(MMDateTime.class);
	}
