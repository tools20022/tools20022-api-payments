 ...
 * {@link com.tools20022.metamodel.MMTransportMessage#checksameMessageTransportSystem}
 */
public class SameMessageTransportSystem implements Consumer<MMTransportMessage> {
	 ...
	 */
	@Override
	public void accept(MMTransportMessage mmBean) {
