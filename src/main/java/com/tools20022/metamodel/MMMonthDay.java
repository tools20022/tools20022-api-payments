...
/**
 * Any set of values drawn from the value space of 'gMonthDay', as specified by
 * W3C Recommendation XML Schema Part 2: Datatypes.
 */
public class MMMonthDay implements MMAbstractDateTimeConcept {
	...
	@Override
	public MetamodelType<? extends MMMonthDay> getMetamodel() {
		return StandardMetamodel2013.metamodel().getTypeByClass(getClass());
	}

	public static MetamodelType<? extends MMMonthDay> metaType() {
		return StandardMetamodel2013.metamodel().getTypeByClass(MMMonthDay.class);
	}
