 ...
 * <p>
 * <embed name="CreditorAgentRole" src="doc-files/CreditorAgentRole.svg">
 * <p>
 ...
 * definition} = "Financial institution servicing an account for the creditor."</li>
 * </ul>
 */
public class CreditorAgentRole extends PaymentPartyRole {
	...
	static public MMBusinessComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			...
			public Class<?> getInstanceClass() {
				return CreditorAgentRole.class;
			}
		});
