...
import com.tools20022.repository.codeset.ExternalChannelCode.InternalXmlAdapter;
...
public class ExternalChannelCode extends MMCode {

	final static private AtomicReference<MMCodeSet> mmObject_lazy = new AtomicReference<>();
	final static private LinkedHashMap<String, ExternalChannelCode> codesByName = new LinkedHashMap<>();

	protected ExternalChannelCode() {
	}
	...
	public static ExternalChannelCode valueOf(String codeName) {
		return codesByName.get(codeName);
	}

	public static ExternalChannelCode[] values() {
		ExternalChannelCode[] values = new ExternalChannelCode[codesByName.size()];
		return codesByName.values().toArray(values);
	}

	protected static class InternalXmlAdapter extends XmlAdapter<String, ExternalChannelCode> {
		@Override
		public ExternalChannelCode unmarshal(String codeName) {
			return valueOf(codeName);
		}

		@Override
		public String marshal(ExternalChannelCode codeObj) {
