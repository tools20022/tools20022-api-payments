...
@XmlType(name = "CancelCaseAssignmentV03", propOrder = {"assignment", "case", "supplementaryData"})
public class CancelCaseAssignmentV03 {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:camt.032.03.03")
