...
@XmlType(name = "UnableToApplyV05", propOrder = {"assignment", "case_", "underlying", "justification", "supplementaryData"})
public class UnableToApplyV05 {
	...
	public UnableToApplyV05 setAssignment(CaseAssignment3 assignment) {
	...
	public UnableToApplyV05 setCase(Case3 case_) {
	...
	public UnableToApplyV05 setUnderlying(UnderlyingTransaction3Choice underlying) {
	...
	public UnableToApplyV05 setJustification(UnableToApplyJustification3Choice justification) {
	...
	public UnableToApplyV05 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
