...
import com.tools20022.repository.msg.AccountStatement8;
...
public class BankToCustomerStatementV07 {
	...
	public static final MMMessageBuildingBlock<BankToCustomerStatementV07, List<AccountStatement8>> mmStatement = new MMMessageBuildingBlock<BankToCustomerStatementV07, List<AccountStatement8>>() {
		{
			...
			minOccurs = 1;
			complexType_lazy = () -> AccountStatement8.mmObject();
		}
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrStatementPaginationRule.for_camt_BankToCustomerStatementV07,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.for_camt_BankToCustomerStatementV07);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.camt.BankToCustomerStatementV07.mmGroupHeader, com.tools20022.repository.area.camt.BankToCustomerStatementV07.mmStatement,
