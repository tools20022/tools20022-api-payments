 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule#forFIToFIPaymentCancellationRequestV06
 * ConstraintMessageOrGroupCaseRule.forFIToFIPaymentCancellationRequestV06}</li>
 * <li>
 ...
 * ConstraintMessageOrTransactionCaseRule.forFIToFIPaymentCancellationRequestV06
 * }</li>
 * <li>
...
@XmlType(name = "FIToFIPaymentCancellationRequestV06", propOrder = {"assignment", "case_", "controlData", "underlying", "supplementaryData"})
public class FIToFIPaymentCancellationRequestV06 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintMessageOrGroupCaseRule.forFIToFIPaymentCancellationRequestV06,
						com.tools20022.repository.constraints.ConstraintMessageOrTransactionCaseRule.forFIToFIPaymentCancellationRequestV06,
						com.tools20022.repository.constraints.ConstraintSupplementaryDataRule.forFIToFIPaymentCancellationRequestV06);
	...
	public FIToFIPaymentCancellationRequestV06 setAssignment(CaseAssignment3 assignment) {
	...
	public FIToFIPaymentCancellationRequestV06 setCase(Case3 case_) {
		this.case_ = case_;
		return this;
	}
	...
	public FIToFIPaymentCancellationRequestV06 setControlData(ControlData1 controlData) {
	...
	public FIToFIPaymentCancellationRequestV06 setUnderlying(List<UnderlyingTransaction16> underlying) {
	...
	public FIToFIPaymentCancellationRequestV06 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
