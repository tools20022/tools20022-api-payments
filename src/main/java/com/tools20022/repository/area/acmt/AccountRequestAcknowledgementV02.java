...
public class AccountRequestAcknowledgementV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, References5> mmReferences = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, References5>() {
		{
			xmlTag = "Refs";
		...
		@Override
		public References5 getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, References5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, Optional<OrganisationIdentification8>> mmFrom = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, Optional<OrganisationIdentification8>>() {
		{
			xmlTag = "Fr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "From";
		...
		@Override
		public Optional<OrganisationIdentification8> getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getFrom();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, Optional<OrganisationIdentification8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<AccountForAction1>> mmAccountIdentification = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<AccountForAction1>>() {
		{
			xmlTag = "AcctId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<AccountForAction1> getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getAccountIdentification();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, List<AccountForAction1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, OrganisationIdentification8> mmOrganisationIdentification = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, OrganisationIdentification8>() {
		{
			xmlTag = "OrgId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public OrganisationIdentification8 getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getOrganisationIdentification();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, OrganisationIdentification8 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, BranchAndFinancialInstitutionIdentification5> mmAccountServicerIdentification = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, BranchAndFinancialInstitutionIdentification5>() {
		{
			xmlTag = "AcctSvcrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getAccountServicerIdentification();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<PartyAndSignature2>> mmDigitalSignature = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<PartyAndSignature2>>() {
		{
			xmlTag = "DgtlSgntr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PartyAndSignature2> getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getDigitalSignature();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, List<PartyAndSignature2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<AccountRequestAcknowledgementV02, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(AccountRequestAcknowledgementV02 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(AccountRequestAcknowledgementV02 obj, List<SupplementaryData1> value) {
