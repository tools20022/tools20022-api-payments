...
public class AccountOpeningAmendmentRequestV02 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, References4> mmReferences = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, References4>() {
		{
			xmlTag = "Refs";
		...
		@Override
		public References4 getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getReferences();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, References4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<OrganisationIdentification8>> mmFrom = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<OrganisationIdentification8>>() {
		{
			xmlTag = "Fr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "From";
		...
		@Override
		public Optional<OrganisationIdentification8> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getFrom();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, Optional<OrganisationIdentification8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<AccountContract2>> mmContractDates = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<AccountContract2>>() {
		{
			xmlTag = "CtrctDts";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "ContractDates";
		...
		@Override
		public Optional<AccountContract2> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getContractDates();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, Optional<AccountContract2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<ContractDocument1>> mmUnderlyingMasterAgreement = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<ContractDocument1>>() {
		{
		...
		@Override
		public Optional<ContractDocument1> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getUnderlyingMasterAgreement();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, Optional<ContractDocument1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, CustomerAccount4> mmAccount = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, CustomerAccount4>() {
		{
			xmlTag = "Acct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Account";
		...
		@Override
		public CustomerAccount4 getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, CustomerAccount4 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, BranchAndFinancialInstitutionIdentification5> mmAccountServicerIdentification = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, BranchAndFinancialInstitutionIdentification5>() {
		{
			xmlTag = "AcctSvcrId";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public BranchAndFinancialInstitutionIdentification5 getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getAccountServicerIdentification();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, BranchAndFinancialInstitutionIdentification5 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Organisation12> mmOrganisation = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Organisation12>() {
		{
			xmlTag = "Org";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Organisation";
		...
		@Override
		public Organisation12 getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getOrganisation();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, Organisation12 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<OperationMandate2>> mmMandate = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<OperationMandate2>>() {
		{
			xmlTag = "Mndt";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Mandate";
		...
		@Override
		public List<OperationMandate2> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getMandate();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, List<OperationMandate2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<Group1>> mmGroup = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<Group1>>() {
		{
			xmlTag = "Grp";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Group";
		...
		@Override
		public List<Group1> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getGroup();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, List<Group1> value) {
			obj.setGroup(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<CashAccount24>> mmReferenceAccount = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, Optional<CashAccount24>>() {
		{
			xmlTag = "RefAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<CashAccount24> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getReferenceAccount();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<PartyAndSignature2>> mmDigitalSignature = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<PartyAndSignature2>>() {
		{
			xmlTag = "DgtlSgntr";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<PartyAndSignature2> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getDigitalSignature();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, List<PartyAndSignature2> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<SupplementaryData1>> mmSupplementaryData = new MMMessageBuildingBlock<AccountOpeningAmendmentRequestV02, List<SupplementaryData1>>() {
		{
			xmlTag = "SplmtryData";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<SupplementaryData1> getValue(AccountOpeningAmendmentRequestV02 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(AccountOpeningAmendmentRequestV02 obj, List<SupplementaryData1> value) {
