...
import com.tools20022.repository.datatype.IrishNSCIdentifier.InternalXmlAdapter;
...
public class IrishNSCIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, IrishNSCIdentifier> {
		@Override
		public IrishNSCIdentifier unmarshal(String value) {
			return new IrishNSCIdentifier(value);
		}

		@Override
		public String marshal(IrishNSCIdentifier typedData) {
