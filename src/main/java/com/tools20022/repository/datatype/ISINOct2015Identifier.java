...
import com.tools20022.repository.datatype.ISINOct2015Identifier.InternalXmlAdapter;
...
public class ISINOct2015Identifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, ISINOct2015Identifier> {
		@Override
		public ISINOct2015Identifier unmarshal(String value) {
			return new ISINOct2015Identifier(value);
		}

		@Override
		public String marshal(ISINOct2015Identifier typedData) {
