...
import com.tools20022.repository.datatype.GermanBankleitzahlIdentifier.InternalXmlAdapter;
...
public class GermanBankleitzahlIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, GermanBankleitzahlIdentifier> {
		@Override
		public GermanBankleitzahlIdentifier unmarshal(String value) {
			return new GermanBankleitzahlIdentifier(value);
		}

		@Override
		public String marshal(GermanBankleitzahlIdentifier typedData) {
