...
import com.tools20022.repository.datatype.PortugueseNCCIdentifier.InternalXmlAdapter;
...
public class PortugueseNCCIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, PortugueseNCCIdentifier> {
		@Override
		public PortugueseNCCIdentifier unmarshal(String value) {
			return new PortugueseNCCIdentifier(value);
		}

		@Override
		public String marshal(PortugueseNCCIdentifier typedData) {
