...
import com.tools20022.repository.datatype.MICIdentifier.InternalXmlAdapter;
...
public class MICIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, MICIdentifier> {
		@Override
		public MICIdentifier unmarshal(String value) {
			return new MICIdentifier(value);
		}

		@Override
		public String marshal(MICIdentifier typedData) {
