...
import com.tools20022.repository.datatype.ValorenIdentifier.InternalXmlAdapter;
 ...
 * identificationScheme} = "Valoren; ValorenIdentifier"</li>
 * <li>
...
public class ValorenIdentifier {
	...
	protected static class InternalXmlAdapter extends XmlAdapter<String, ValorenIdentifier> {
		@Override
		public ValorenIdentifier unmarshal(String value) {
			return new ValorenIdentifier(value);
		}

		@Override
		public String marshal(ValorenIdentifier typedData) {
