...
public class PaymentTransaction83 {
	...
	public static final MMMessageAttribute mmStatusIdentification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> PaymentTransaction83.mmObject();
			isDerived = false;
			xmlTag = "StsId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PaymentTransaction83.mmStatusIdentification, PaymentTransaction83.mmOriginalInstructionIdentification, PaymentTransaction83.mmOriginalEndToEndIdentification,
						PaymentTransaction83.mmTransactionStatus, PaymentTransaction83.mmStatusReasonInformation, PaymentTransaction83.mmChargesInformation, PaymentTransaction83.mmAcceptanceDateTime,
						PaymentTransaction83.mmAccountServicerReference, PaymentTransaction83.mmClearingSystemReference, PaymentTransaction83.mmOriginalTransactionReference, PaymentTransaction83.mmSupplementaryData);
	...
	public OriginalTransactionReference26 getOriginalTransactionReference() {
		return originalTransactionReference;
	}

	public void setOriginalTransactionReference(com.tools20022.repository.msg.OriginalTransactionReference26 originalTransactionReference) {
