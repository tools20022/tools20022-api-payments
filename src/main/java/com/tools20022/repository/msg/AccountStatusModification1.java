...
public class AccountStatusModification1 {
	...
	public AccountStatusModification1 setModificationCode(Modification1Code modificationCode) {
	...
	public AccountStatusModification1 setStatus(AccountStatus3Code status) {
