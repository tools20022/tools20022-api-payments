...
@XmlType(name = "GenericIdentification30", propOrder = {"identification", "issuer", "schemeName"})
public class GenericIdentification30 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.msg.GenericIdentification30.mmObject();
			isDerived = false;
			xmlTag = "Id";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification30.mmIdentification, com.tools20022.repository.msg.GenericIdentification30.mmIssuer,
						com.tools20022.repository.msg.GenericIdentification30.mmSchemeName);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GenericIdentification30";
	...
	public GenericIdentification30 setIdentification(Exact4AlphaNumericText identification) {
	...
	public GenericIdentification30 setIssuer(Max35Text issuer) {
	...
	public GenericIdentification30 setSchemeName(Max35Text schemeName) {
