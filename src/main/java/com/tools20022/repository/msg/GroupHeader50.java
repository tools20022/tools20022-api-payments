...
public class GroupHeader50 {
	...
	public static final MMMessageAssociationEnd mmSettlementInformation = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SettlementInstruction2.mmObject();
		}
	};
	...
	public GroupHeader50 setSettlementInformation(com.tools20022.repository.msg.SettlementInstruction2 settlementInformation) {
	...
	public GroupHeader50 setPaymentTypeInformation(com.tools20022.repository.msg.PaymentTypeInformation25 paymentTypeInformation) {
	...
	public GroupHeader50 setInstructingAgent(com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5 instructingAgent) {
	...
	public GroupHeader50 setInstructedAgent(com.tools20022.repository.msg.BranchAndFinancialInstitutionIdentification5 instructedAgent) {
