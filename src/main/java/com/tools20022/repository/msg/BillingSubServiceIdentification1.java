...
import com.tools20022.repository.choice.BillingSubServiceQualifier1Choice;
	...
	public static final MMMessageAttribute<BillingSubServiceIdentification1, BillingSubServiceQualifier1Choice> mmIssuer = new MMMessageAttribute<BillingSubServiceIdentification1, BillingSubServiceQualifier1Choice>() {
		{
			...
			name = "Issuer";
			definition = "Specifies the qualifier of the sub service.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<BillingSubServiceIdentification1, Max35Text> mmIdentification = new MMMessageAttribute<BillingSubServiceIdentification1, Max35Text>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Further defines a financial institution service, through the provision of the value required by the sub service qualifier, such as the actual lockbox number or store number.";
			maxOccurs = 1;
			minOccurs = 1;
