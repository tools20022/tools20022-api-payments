...
public class GroupHeader60 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.GroupHeader60 GroupHeader60}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader60, Max35Text> mmMessageIdentification = new MMMessageAttribute<GroupHeader60, Max35Text>() {
		{
			businessElementTrace_lazy = () -> PaymentIdentification.mmExecutionIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader60.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
		...
		@Override
		public Max35Text getValue(GroupHeader60 obj) {
			return obj.getMessageIdentification();
		}

		@Override
		public void setValue(GroupHeader60 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GroupHeader60, ISODateTime> mmCreationDateTime = new MMMessageAttribute<GroupHeader60, ISODateTime>() {
		{
		...
		@Override
		public ISODateTime getValue(GroupHeader60 obj) {
			return obj.getCreationDateTime();
		}

		@Override
		public void setValue(GroupHeader60 obj, ISODateTime value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GroupHeader60, Optional<Party12Choice>> mmMessageRecipient = new MMMessageAssociationEnd<GroupHeader60, Optional<Party12Choice>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.GroupHeader60.mmObject();
			isDerived = false;
			xmlTag = "MsgRcpt";
		...
		@Override
		public Optional<Party12Choice> getValue(GroupHeader60 obj) {
			return obj.getMessageRecipient();
		}

		@Override
		public void setValue(GroupHeader60 obj, Optional<Party12Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader60.mmMessageIdentification, com.tools20022.repository.msg.GroupHeader60.mmCreationDateTime,
						com.tools20022.repository.msg.GroupHeader60.mmMessageRecipient);
	...
	public GroupHeader60 setMessageIdentification(Max35Text messageIdentification) {
	...
	public GroupHeader60 setCreationDateTime(ISODateTime creationDateTime) {
		this.creationDateTime = Objects.requireNonNull(creationDateTime);
		return this;
	}

	public Optional<Party12Choice> getMessageRecipient() {
		return messageRecipient == null ? Optional.empty() : Optional.of(messageRecipient);
	}

	public GroupHeader60 setMessageRecipient(Party12Choice messageRecipient) {
