...
public class GroupHeader52 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader52.mmMessageIdentification, GroupHeader52.mmCreationDateTime, GroupHeader52.mmInitiatingParty, GroupHeader52.mmForwardingAgent, GroupHeader52.mmDebtorAgent,
						GroupHeader52.mmCreditorAgent);
