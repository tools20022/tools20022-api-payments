...
public class ContactDetails3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<NamePrefix1Code>> mmNamePrefix = new MMMessageAttribute<ContactDetails3, Optional<NamePrefix1Code>>() {
		{
		...
		@Override
		public Optional<NamePrefix1Code> getValue(ContactDetails3 obj) {
			return obj.getNamePrefix();
		}

		@Override
		public void setValue(ContactDetails3 obj, Optional<NamePrefix1Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<Max140Text>> mmName = new MMMessageAttribute<ContactDetails3, Optional<Max140Text>>() {
		{
		...
		@Override
		public Optional<Max140Text> getValue(ContactDetails3 obj) {
			return obj.getName();
		}

		@Override
		public void setValue(ContactDetails3 obj, Optional<Max140Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>> mmPhoneNumber = new MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>>() {
		{
		...
		@Override
		public Optional<PhoneNumber> getValue(ContactDetails3 obj) {
			return obj.getPhoneNumber();
		}

		@Override
		public void setValue(ContactDetails3 obj, Optional<PhoneNumber> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>> mmMobileNumber = new MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>> mmFaxNumber = new MMMessageAttribute<ContactDetails3, Optional<PhoneNumber>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<Max2048Text>> mmEmailAddress = new MMMessageAttribute<ContactDetails3, Optional<Max2048Text>>() {
		{
		...
		@Override
		public Optional<Max2048Text> getValue(ContactDetails3 obj) {
			return obj.getEmailAddress();
		}

		@Override
		public void setValue(ContactDetails3 obj, Optional<Max2048Text> value) {
			obj.setEmailAddress(value.orElse(null));
		}
	};
	@XmlElement(name = "Othr")
	protected List<OtherContact1> other;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, List<OtherContact1>> mmOther = new MMMessageAttribute<ContactDetails3, List<OtherContact1>>() {
		{
			...
			minOccurs = 0;
			complexType_lazy = () -> OtherContact1.mmObject();
		}

		@Override
		public List<OtherContact1> getValue(ContactDetails3 obj) {
			return obj.getOther();
		}

		@Override
		public void setValue(ContactDetails3 obj, List<OtherContact1> value) {
			obj.setOther(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<ContactDetails3, Optional<PreferredContactMethod1Code>> mmPreferredMethod = new MMMessageAttribute<ContactDetails3, Optional<PreferredContactMethod1Code>>() {
		{
		...
		@Override
		public Optional<PreferredContactMethod1Code> getValue(ContactDetails3 obj) {
			return obj.getPreferredMethod();
		}

		@Override
		public void setValue(ContactDetails3 obj, Optional<PreferredContactMethod1Code> value) {
			obj.setPreferredMethod(value.orElse(null));
		}
	};
	...
	public ContactDetails3 setOther(List<OtherContact1> other) {
