...
public class OrganisationIdentification7 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<OrganisationIdentification7, Optional<AnyBICIdentifier>> mmAnyBIC = new MMMessageAttribute<OrganisationIdentification7, Optional<AnyBICIdentifier>>() {
		{
		...
		@Override
		public Optional<AnyBICIdentifier> getValue(OrganisationIdentification7 obj) {
			return obj.getAnyBIC();
		}

		@Override
		public void setValue(OrganisationIdentification7 obj, Optional<AnyBICIdentifier> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OrganisationIdentification7, List<GenericOrganisationIdentification1>> mmOther = new MMMessageAssociationEnd<OrganisationIdentification7, List<GenericOrganisationIdentification1>>() {
		{
		...
		@Override
		public List<GenericOrganisationIdentification1> getValue(OrganisationIdentification7 obj) {
			return obj.getOther();
		}

		@Override
		public void setValue(OrganisationIdentification7 obj, List<GenericOrganisationIdentification1> value) {
			obj.setOther(value);
		}
	};
	...
	public OrganisationIdentification7 setOther(List<GenericOrganisationIdentification1> other) {
