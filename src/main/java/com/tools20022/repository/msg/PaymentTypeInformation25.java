...
public class PaymentTypeInformation25 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation25, Optional<Priority2Code>> mmInstructionPriority = new MMMessageAttribute<PaymentTypeInformation25, Optional<Priority2Code>>() {
		{
		...
		@Override
		public Optional<Priority2Code> getValue(PaymentTypeInformation25 obj) {
			return obj.getInstructionPriority();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<Priority2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation25, Optional<ClearingChannel2Code>> mmClearingChannel = new MMMessageAttribute<PaymentTypeInformation25, Optional<ClearingChannel2Code>>() {
		{
		...
		@Override
		public Optional<ClearingChannel2Code> getValue(PaymentTypeInformation25 obj) {
			return obj.getClearingChannel();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<ClearingChannel2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation25, Optional<ServiceLevel8Choice>> mmServiceLevel = new MMMessageAssociationEnd<PaymentTypeInformation25, Optional<ServiceLevel8Choice>>() {
		{
		...
		@Override
		public Optional<ServiceLevel8Choice> getValue(PaymentTypeInformation25 obj) {
			return obj.getServiceLevel();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<ServiceLevel8Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation25, Optional<LocalInstrument2Choice>> mmLocalInstrument = new MMMessageAssociationEnd<PaymentTypeInformation25, Optional<LocalInstrument2Choice>>() {
		{
		...
		@Override
		public Optional<LocalInstrument2Choice> getValue(PaymentTypeInformation25 obj) {
			return obj.getLocalInstrument();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<LocalInstrument2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTypeInformation25, Optional<SequenceType3Code>> mmSequenceType = new MMMessageAttribute<PaymentTypeInformation25, Optional<SequenceType3Code>>() {
		{
		...
		@Override
		public Optional<SequenceType3Code> getValue(PaymentTypeInformation25 obj) {
			return obj.getSequenceType();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<SequenceType3Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTypeInformation25, Optional<CategoryPurpose1Choice>> mmCategoryPurpose = new MMMessageAssociationEnd<PaymentTypeInformation25, Optional<CategoryPurpose1Choice>>() {
		{
		...
		@Override
		public Optional<CategoryPurpose1Choice> getValue(PaymentTypeInformation25 obj) {
			return obj.getCategoryPurpose();
		}

		@Override
		public void setValue(PaymentTypeInformation25 obj, Optional<CategoryPurpose1Choice> value) {
