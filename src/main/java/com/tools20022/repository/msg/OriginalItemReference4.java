...
import com.tools20022.repository.msg.RemittanceInformation11;
...
public class OriginalItemReference4 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<CashAccount24>> mmAccount = new MMMessageAssociationEnd<OriginalItemReference4, Optional<CashAccount24>>() {
		{
			businessElementTrace_lazy = () -> CashEntry.mmCashAccount;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalItemReference4.mmObject();
			isDerived = false;
			xmlTag = "Acct";
		...
		@Override
		public Optional<CashAccount24> getValue(OriginalItemReference4 obj) {
			return obj.getAccount();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<CashAccount24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<Party12Choice>> mmAccountOwner = new MMMessageAssociationEnd<OriginalItemReference4, Optional<Party12Choice>>() {
		{
		...
		@Override
		public Optional<Party12Choice> getValue(OriginalItemReference4 obj) {
			return obj.getAccountOwner();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<Party12Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>> mmAccountServicer = new MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
		...
		@Override
		public Optional<BranchAndFinancialInstitutionIdentification5> getValue(OriginalItemReference4 obj) {
			return obj.getAccountServicer();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<BranchAndFinancialInstitutionIdentification5> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<CashAccount24>> mmRelatedAccount = new MMMessageAssociationEnd<OriginalItemReference4, Optional<CashAccount24>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<Party12Choice>> mmDebtor = new MMMessageAssociationEnd<OriginalItemReference4, Optional<Party12Choice>>() {
		{
			businessElementTrace_lazy = () -> Party.mmIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalItemReference4.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>> mmDebtorAgent = new MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>> mmIntermediaryAgent = new MMMessageAssociationEnd<OriginalItemReference4, Optional<BranchAndFinancialInstitutionIdentification5>>() {
		{
			businessComponentTrace_lazy = () -> Organisation.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.OriginalItemReference4.mmObject();
			isDerived = false;
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<Purpose2Choice>> mmPurpose = new MMMessageAssociationEnd<OriginalItemReference4, Optional<Purpose2Choice>>() {
		{
		...
		@Override
		public Optional<Purpose2Choice> getValue(OriginalItemReference4 obj) {
			return obj.getPurpose();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<Purpose2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<RemittanceLocation4>> mmRelatedRemittanceInformation = new MMMessageAssociationEnd<OriginalItemReference4, Optional<RemittanceLocation4>>() {
		{
		...
		@Override
		public Optional<RemittanceLocation4> getValue(OriginalItemReference4 obj) {
			return obj.getRelatedRemittanceInformation();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<RemittanceLocation4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<OriginalItemReference4, Optional<RemittanceInformation11>> mmRemittanceInformation = new MMMessageAssociationEnd<OriginalItemReference4, Optional<RemittanceInformation11>>() {
		{
		...
		@Override
		public Optional<RemittanceInformation11> getValue(OriginalItemReference4 obj) {
			return obj.getRemittanceInformation();
		}

		@Override
		public void setValue(OriginalItemReference4 obj, Optional<RemittanceInformation11> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.OriginalItemReference4.mmAccount, com.tools20022.repository.msg.OriginalItemReference4.mmAccountOwner,
						com.tools20022.repository.msg.OriginalItemReference4.mmAccountServicer, com.tools20022.repository.msg.OriginalItemReference4.mmRelatedAccount, com.tools20022.repository.msg.OriginalItemReference4.mmDebtor,
						com.tools20022.repository.msg.OriginalItemReference4.mmDebtorAgent, com.tools20022.repository.msg.OriginalItemReference4.mmIntermediaryAgent, com.tools20022.repository.msg.OriginalItemReference4.mmPurpose,
						com.tools20022.repository.msg.OriginalItemReference4.mmRelatedRemittanceInformation, com.tools20022.repository.msg.OriginalItemReference4.mmRemittanceInformation);
	...
	public OriginalItemReference4 setAccount(CashAccount24 account) {
	...
	public OriginalItemReference4 setAccountOwner(Party12Choice accountOwner) {
	...
	public OriginalItemReference4 setAccountServicer(BranchAndFinancialInstitutionIdentification5 accountServicer) {
	...
	public OriginalItemReference4 setRelatedAccount(CashAccount24 relatedAccount) {
	...
	public OriginalItemReference4 setDebtor(Party12Choice debtor) {
		this.debtor = debtor;
		return this;
	}
	...
	public OriginalItemReference4 setDebtorAgent(BranchAndFinancialInstitutionIdentification5 debtorAgent) {
	...
	public OriginalItemReference4 setIntermediaryAgent(BranchAndFinancialInstitutionIdentification5 intermediaryAgent) {
	...
	public OriginalItemReference4 setPurpose(Purpose2Choice purpose) {
	...
	public OriginalItemReference4 setRelatedRemittanceInformation(RemittanceLocation4 relatedRemittanceInformation) {
	...
	public OriginalItemReference4 setRemittanceInformation(RemittanceInformation11 remittanceInformation) {
