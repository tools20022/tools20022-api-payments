 ...
 * <li>{@linkplain com.tools20022.repository.msg.PaymentTransaction95#mmCase
...
@XmlType(name = "PaymentTransaction95", propOrder = {"cancellationIdentification", "case_", "originalInstructionIdentification", "originalEndToEndIdentification", "originalInstructedAmount", "originalRequestedExecutionDate",
...
public class PaymentTransaction95 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.PaymentTransaction95
	 * PaymentTransaction95}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>> mmCancellationIdentification = new MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction95.mmObject();
			isDerived = false;
			xmlTag = "CxlId";
		...
		@Override
		public Optional<Max35Text> getValue(PaymentTransaction95 obj) {
			return obj.getCancellationIdentification();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction95, Optional<Case4>> mmCase = new MMMessageAssociationEnd<PaymentTransaction95, Optional<Case4>>() {
		{
		...
		@Override
		public Optional<Case4> getValue(PaymentTransaction95 obj) {
			return obj.getCase();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<Case4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<PaymentTransaction95, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<ActiveOrHistoricCurrencyAndAmount>> mmOriginalInstructedAmount = new MMMessageAttribute<PaymentTransaction95, Optional<ActiveOrHistoricCurrencyAndAmount>>() {
		{
		...
		@Override
		public Optional<ActiveOrHistoricCurrencyAndAmount> getValue(PaymentTransaction95 obj) {
			return obj.getOriginalInstructedAmount();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<ActiveOrHistoricCurrencyAndAmount> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<DateAndDateTime2Choice>> mmOriginalRequestedExecutionDate = new MMMessageAttribute<PaymentTransaction95, Optional<DateAndDateTime2Choice>>() {
		{
		...
		@Override
		public Optional<DateAndDateTime2Choice> getValue(PaymentTransaction95 obj) {
			return obj.getOriginalRequestedExecutionDate();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<DateAndDateTime2Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, Optional<ISODate>> mmOriginalRequestedCollectionDate = new MMMessageAttribute<PaymentTransaction95, Optional<ISODate>>() {
		{
			businessElementTrace_lazy = () -> Obligation.mmRequestedSettlementDate;
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction95.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<ISODate> getValue(PaymentTransaction95 obj) {
			return obj.getOriginalRequestedCollectionDate();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<ISODate> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction95, List<PaymentCancellationReason4>> mmCancellationReasonInformation = new MMMessageAssociationEnd<PaymentTransaction95, List<PaymentCancellationReason4>>() {
		{
		...
		@Override
		public List<PaymentCancellationReason4> getValue(PaymentTransaction95 obj) {
			return obj.getCancellationReasonInformation();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, List<PaymentCancellationReason4> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PaymentTransaction95, Optional<OriginalTransactionReference27>> mmOriginalTransactionReference = new MMMessageAssociationEnd<PaymentTransaction95, Optional<OriginalTransactionReference27>>() {
		{
		...
		@Override
		public Optional<OriginalTransactionReference27> getValue(PaymentTransaction95 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, Optional<OriginalTransactionReference27> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PaymentTransaction95, List<SupplementaryData1>> mmSupplementaryData = new MMMessageAttribute<PaymentTransaction95, List<SupplementaryData1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PaymentTransaction95.mmObject();
			isDerived = false;
			xmlTag = "SplmtryData";
		...
		@Override
		public List<SupplementaryData1> getValue(PaymentTransaction95 obj) {
			return obj.getSupplementaryData();
		}

		@Override
		public void setValue(PaymentTransaction95 obj, List<SupplementaryData1> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PaymentTransaction95.mmCancellationIdentification, com.tools20022.repository.msg.PaymentTransaction95.mmCase,
						com.tools20022.repository.msg.PaymentTransaction95.mmOriginalInstructionIdentification, com.tools20022.repository.msg.PaymentTransaction95.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.PaymentTransaction95.mmOriginalInstructedAmount, com.tools20022.repository.msg.PaymentTransaction95.mmOriginalRequestedExecutionDate,
						com.tools20022.repository.msg.PaymentTransaction95.mmOriginalRequestedCollectionDate, com.tools20022.repository.msg.PaymentTransaction95.mmCancellationReasonInformation,
						com.tools20022.repository.msg.PaymentTransaction95.mmOriginalTransactionReference, com.tools20022.repository.msg.PaymentTransaction95.mmSupplementaryData);
				trace_lazy = () -> Payment.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PaymentTransaction95";
	...
	public PaymentTransaction95 setCancellationIdentification(Max35Text cancellationIdentification) {
	...
	public PaymentTransaction95 setCase(Case4 case_) {
		this.case_ = case_;
		return this;
	}
	...
	public PaymentTransaction95 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public PaymentTransaction95 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public PaymentTransaction95 setOriginalInstructedAmount(ActiveOrHistoricCurrencyAndAmount originalInstructedAmount) {
	...
	public PaymentTransaction95 setOriginalRequestedExecutionDate(DateAndDateTime2Choice originalRequestedExecutionDate) {
	...
	public PaymentTransaction95 setOriginalRequestedCollectionDate(ISODate originalRequestedCollectionDate) {
	...
	public PaymentTransaction95 setCancellationReasonInformation(List<PaymentCancellationReason4> cancellationReasonInformation) {
	...
	public PaymentTransaction95 setOriginalTransactionReference(OriginalTransactionReference27 originalTransactionReference) {
	...
	public PaymentTransaction95 setSupplementaryData(List<SupplementaryData1> supplementaryData) {
