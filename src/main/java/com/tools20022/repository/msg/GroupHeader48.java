 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader48#mmAuthorisation
 * GroupHeader48.mmAuthorisation}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.GroupHeader48#mmNumberOfTransactions
 * GroupHeader48.mmNumberOfTransactions}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader48#mmControlSum
 * GroupHeader48.mmControlSum}</li>
 * <li>
...
@XmlType(name = "GroupHeader48", propOrder = {"messageIdentification", "creationDateTime", "authorisation", "numberOfTransactions", "controlSum", "initiatingParty", "forwardingAgent"})
public class GroupHeader48 {
	...
	public static final MMMessageAttribute<GroupHeader48, Max35Text> mmMessageIdentification = new MMMessageAttribute<GroupHeader48, Max35Text>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyControlHeader1.mmMessageIdentification);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<GroupHeader48, ISODateTime> mmCreationDateTime = new MMMessageAttribute<GroupHeader48, ISODateTime>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyControlHeader1.mmCreationDateTime);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute<GroupHeader48, Max15NumericText> mmNumberOfTransactions = new MMMessageAttribute<GroupHeader48, Max15NumericText>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyControlHeader1.mmNumberOfItems);
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd<GroupHeader48, PartyIdentification43> mmInitiatingParty = new MMMessageAssociationEnd<GroupHeader48, PartyIdentification43>() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(CurrencyControlHeader1.mmInitiatingParty);
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GroupHeader48.mmMessageIdentification, com.tools20022.repository.msg.GroupHeader48.mmCreationDateTime,
						com.tools20022.repository.msg.GroupHeader48.mmAuthorisation, com.tools20022.repository.msg.GroupHeader48.mmNumberOfTransactions, com.tools20022.repository.msg.GroupHeader48.mmControlSum,
						com.tools20022.repository.msg.GroupHeader48.mmInitiatingParty, com.tools20022.repository.msg.GroupHeader48.mmForwardingAgent);
				messageBuildingBlock_lazy = () -> Arrays.asList(CustomerCreditTransferInitiationV08.mmGroupHeader);
	...
	public GroupHeader48 setMessageIdentification(Max35Text messageIdentification) {
	...
	public GroupHeader48 setCreationDateTime(ISODateTime creationDateTime) {
	...
	public GroupHeader48 setAuthorisation(List<Authorisation1Choice> authorisation) {
	...
	public GroupHeader48 setNumberOfTransactions(Max15NumericText numberOfTransactions) {
	...
	public GroupHeader48 setControlSum(DecimalNumber controlSum) {
