...
public class GenericIdentification1 {
	...
	public static final MMMessageAttribute Identification = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> GenericIdentification1.mmObject();
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.GenericIdentification1.Identification, com.tools20022.repository.msg.GenericIdentification1.SchemeName,
						com.tools20022.repository.msg.GenericIdentification1.Issuer);
