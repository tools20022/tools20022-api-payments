...
@XmlType(name = "UnderlyingPaymentTransaction3", propOrder = {"originalGroupInformation", "originalInstructionIdentification", "originalEndToEndIdentification", "originalTransactionIdentification", "originalInterbankSettlementAmount",
		"originalInterbankSettlementDate", "originalTransactionReference"})
public class UnderlyingPaymentTransaction3 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<UnderlyingPaymentTransaction3, Optional<UnderlyingGroupInformation1>> mmOriginalGroupInformation = new MMMessageAssociationEnd<UnderlyingPaymentTransaction3, Optional<UnderlyingGroupInformation1>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmObject();
			isDerived = false;
			xmlTag = "OrgnlGrpInf";
		...
		@Override
		public Optional<UnderlyingGroupInformation1> getValue(UnderlyingPaymentTransaction3 obj) {
			return obj.getOriginalGroupInformation();
		}

		@Override
		public void setValue(UnderlyingPaymentTransaction3 obj, Optional<UnderlyingGroupInformation1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>> mmOriginalInstructionIdentification = new MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(UnderlyingPaymentTransaction3 obj) {
			return obj.getOriginalInstructionIdentification();
		}

		@Override
		public void setValue(UnderlyingPaymentTransaction3 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>> mmOriginalEndToEndIdentification = new MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>> mmOriginalTransactionIdentification = new MMMessageAttribute<UnderlyingPaymentTransaction3, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentTransaction3, ActiveOrHistoricCurrencyAndAmount> mmOriginalInterbankSettlementAmount = new MMMessageAttribute<UnderlyingPaymentTransaction3, ActiveOrHistoricCurrencyAndAmount>() {
		{
		...
		@Override
		public ActiveOrHistoricCurrencyAndAmount getValue(UnderlyingPaymentTransaction3 obj) {
			return obj.getOriginalInterbankSettlementAmount();
		}

		@Override
		public void setValue(UnderlyingPaymentTransaction3 obj, ActiveOrHistoricCurrencyAndAmount value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<UnderlyingPaymentTransaction3, ISODate> mmOriginalInterbankSettlementDate = new MMMessageAttribute<UnderlyingPaymentTransaction3, ISODate>() {
		{
		...
		@Override
		public ISODate getValue(UnderlyingPaymentTransaction3 obj) {
			return obj.getOriginalInterbankSettlementDate();
		}

		@Override
		public void setValue(UnderlyingPaymentTransaction3 obj, ISODate value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<UnderlyingPaymentTransaction3, Optional<OriginalTransactionReference27>> mmOriginalTransactionReference = new MMMessageAssociationEnd<UnderlyingPaymentTransaction3, Optional<OriginalTransactionReference27>>() {
		{
		...
		@Override
		public Optional<OriginalTransactionReference27> getValue(UnderlyingPaymentTransaction3 obj) {
			return obj.getOriginalTransactionReference();
		}

		@Override
		public void setValue(UnderlyingPaymentTransaction3 obj, Optional<OriginalTransactionReference27> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalGroupInformation,
						com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalInstructionIdentification, com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalEndToEndIdentification,
						com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalTransactionIdentification, com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalInterbankSettlementAmount,
						com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalInterbankSettlementDate, com.tools20022.repository.msg.UnderlyingPaymentTransaction3.mmOriginalTransactionReference);
				trace_lazy = () -> PaymentInstruction.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintOriginalIdentificationRule.forUnderlyingPaymentTransaction3);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "UnderlyingPaymentTransaction3";
	...
	public UnderlyingPaymentTransaction3 setOriginalGroupInformation(UnderlyingGroupInformation1 originalGroupInformation) {
	...
	public UnderlyingPaymentTransaction3 setOriginalInstructionIdentification(Max35Text originalInstructionIdentification) {
	...
	public UnderlyingPaymentTransaction3 setOriginalEndToEndIdentification(Max35Text originalEndToEndIdentification) {
	...
	public UnderlyingPaymentTransaction3 setOriginalTransactionIdentification(Max35Text originalTransactionIdentification) {
	...
	public UnderlyingPaymentTransaction3 setOriginalInterbankSettlementAmount(ActiveOrHistoricCurrencyAndAmount originalInterbankSettlementAmount) {
	...
	public UnderlyingPaymentTransaction3 setOriginalInterbankSettlementDate(ISODate originalInterbankSettlementDate) {
	...
	public UnderlyingPaymentTransaction3 setOriginalTransactionReference(OriginalTransactionReference27 originalTransactionReference) {
