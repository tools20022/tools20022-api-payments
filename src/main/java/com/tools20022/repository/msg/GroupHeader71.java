 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader71#mmAuthorisation
 * GroupHeader71.mmAuthorisation}</li>
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader71#mmBatchBooking
 ...
 * <li>{@linkplain com.tools20022.repository.msg.GroupHeader71#mmGroupReversal
...
@XmlType(name = "GroupHeader71", propOrder = {"messageIdentification", "creationDateTime", "authorisation", "batchBooking", "numberOfTransactions", "controlSum", "groupReversal", "totalReversedInterbankSettlementAmount",
...
public class GroupHeader71 {
	...
	public static final MMMessageAttribute mmMessageIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> GroupHeader71.mmObject();
			isDerived = false;
			xmlTag = "MsgId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(GroupHeader71.mmMessageIdentification, GroupHeader71.mmCreationDateTime, GroupHeader71.mmAuthorisation, GroupHeader71.mmBatchBooking, GroupHeader71.mmNumberOfTransactions,
						GroupHeader71.mmControlSum, GroupHeader71.mmGroupReversal, GroupHeader71.mmTotalReversedInterbankSettlementAmount, GroupHeader71.mmInterbankSettlementDate, GroupHeader71.mmSettlementInformation,
						GroupHeader71.mmInstructingAgent, GroupHeader71.mmInstructedAgent);
				messageBuildingBlock_lazy = () -> Arrays.asList(FIToFIPaymentReversalV07.mmGroupHeader);
