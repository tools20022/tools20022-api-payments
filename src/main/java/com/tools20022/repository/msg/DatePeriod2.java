 ...
 * previousVersion} = {@linkplain com.tools20022.repository.msg.DatePeriod1
 * DatePeriod1}</li>
 * </ul>
 */
...
public class DatePeriod2 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.DatePeriod2 DatePeriod2}</li>
	 ...
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DatePeriod1#mmFromDate
	...
	public static final MMMessageAttribute<DatePeriod2, ISODate> mmFromDate = new MMMessageAttribute<DatePeriod2, ISODate>() {
		{
			...
			previousVersion_lazy = () -> DatePeriod1.mmFromDate;
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * {@linkplain com.tools20022.metamodel.MMModelEntity#getPreviousVersion
	 * previousVersion} =
	 * {@linkplain com.tools20022.repository.msg.DatePeriod1#mmToDate
	...
	public static final MMMessageAttribute<DatePeriod2, ISODate> mmToDate = new MMMessageAttribute<DatePeriod2, ISODate>() {
		{
			...
			previousVersion_lazy = () -> DatePeriod1.mmToDate;
			maxOccurs = 1;
			minOccurs = 1;
			simpleType_lazy = () -> ISODate.mmObject();
		}
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DatePeriod2.mmFromDate, com.tools20022.repository.msg.DatePeriod2.mmToDate);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DatePeriod2";
				definition = "Range of time defined by a start date and an end date.";
				previousVersion_lazy = () -> DatePeriod1.mmObject();
			}
		});
