...
public class OriginalMessageInformation1 {
	...
	public OriginalMessageInformation1 setMessageIdentification(Max35Text messageIdentification) {
	...
	public OriginalMessageInformation1 setMessageNameIdentification(Max35Text messageNameIdentification) {
	...
	public OriginalMessageInformation1 setCreationDateTime(ISODateTime creationDateTime) {
