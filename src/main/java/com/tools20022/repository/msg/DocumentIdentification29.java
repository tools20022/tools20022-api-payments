...
@XmlType(name = "DocumentIdentification29", propOrder = {"identification", "dateOfIssue"})
public class DocumentIdentification29 {
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.msg.DocumentIdentification29.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Identifies the document.";
			previousVersion_lazy = () -> DocumentIdentification28.mmIdentification;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAttribute mmDateOfIssue = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> DocumentIdentification28.mmDateOfIssue;
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.DocumentIdentification29.mmIdentification, com.tools20022.repository.msg.DocumentIdentification29.mmDateOfIssue);
				trace_lazy = () -> Document.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DocumentIdentification29";
				definition = "Identifies a document by a unique identification and a date of issue.";
				previousVersion_lazy = () -> DocumentIdentification28.mmObject();
			}
		});
	...
	public DocumentIdentification29 setIdentification(Max35Text identification) {
	...
	public DocumentIdentification29 setDateOfIssue(ISODate dateOfIssue) {
