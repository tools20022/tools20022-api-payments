...
public class DirectDebitTransactionInformation21 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DirectDebitTransactionInformation21.mmPaymentIdentification, DirectDebitTransactionInformation21.mmPaymentTypeInformation,
						DirectDebitTransactionInformation21.mmInterbankSettlementAmount, DirectDebitTransactionInformation21.mmInterbankSettlementDate, DirectDebitTransactionInformation21.mmSettlementPriority,
						DirectDebitTransactionInformation21.mmInstructedAmount, DirectDebitTransactionInformation21.mmExchangeRate, DirectDebitTransactionInformation21.mmChargeBearer,
						DirectDebitTransactionInformation21.mmChargesInformation, DirectDebitTransactionInformation21.mmRequestedCollectionDate, DirectDebitTransactionInformation21.mmDirectDebitTransaction,
						DirectDebitTransactionInformation21.mmCreditor, DirectDebitTransactionInformation21.mmCreditorAccount, DirectDebitTransactionInformation21.mmCreditorAgent, DirectDebitTransactionInformation21.mmCreditorAgentAccount,
						DirectDebitTransactionInformation21.mmUltimateCreditor, DirectDebitTransactionInformation21.mmInitiatingParty, DirectDebitTransactionInformation21.mmInstructingAgent,
						DirectDebitTransactionInformation21.mmInstructedAgent, DirectDebitTransactionInformation21.mmIntermediaryAgent1, DirectDebitTransactionInformation21.mmIntermediaryAgent1Account,
						DirectDebitTransactionInformation21.mmIntermediaryAgent2, DirectDebitTransactionInformation21.mmIntermediaryAgent2Account, DirectDebitTransactionInformation21.mmIntermediaryAgent3,
						DirectDebitTransactionInformation21.mmIntermediaryAgent3Account, DirectDebitTransactionInformation21.mmDebtor, DirectDebitTransactionInformation21.mmDebtorAccount, DirectDebitTransactionInformation21.mmDebtorAgent,
						DirectDebitTransactionInformation21.mmDebtorAgentAccount, DirectDebitTransactionInformation21.mmUltimateDebtor, DirectDebitTransactionInformation21.mmPurpose,
						DirectDebitTransactionInformation21.mmRegulatoryReporting, DirectDebitTransactionInformation21.mmRelatedRemittanceInformation, DirectDebitTransactionInformation21.mmRemittanceInformation,
						DirectDebitTransactionInformation21.mmSupplementaryData);
	...
	public DirectDebitTransaction9 getDirectDebitTransaction() {
		return directDebitTransaction;
	}

	public void setDirectDebitTransaction(com.tools20022.repository.msg.DirectDebitTransaction9 directDebitTransaction) {
