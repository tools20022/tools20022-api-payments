...
public class BillingServiceCommonIdentification1 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.BillingServiceCommonIdentification1.mmIssuer, com.tools20022.repository.msg.BillingServiceCommonIdentification1.mmIdentification);
	...
	public BillingServiceCommonIdentification1 setIssuer(Max6Text issuer) {
	...
	public BillingServiceCommonIdentification1 setIdentification(Max8Text identification) {
