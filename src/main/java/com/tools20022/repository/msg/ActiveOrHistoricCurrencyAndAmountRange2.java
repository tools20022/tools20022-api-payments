...
public class ActiveOrHistoricCurrencyAndAmountRange2 {
	...
	public static final MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange2, ImpliedCurrencyAmountRange1Choice> mmAmount = new MMMessageAttribute<ActiveOrHistoricCurrencyAndAmountRange2, ImpliedCurrencyAmountRange1Choice>() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange2.mmObject();
			isDerived = false;
			xmlTag = "Amt";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange2.mmAmount, com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange2.mmCreditDebitIndicator,
						com.tools20022.repository.msg.ActiveOrHistoricCurrencyAndAmountRange2.mmCurrency);
