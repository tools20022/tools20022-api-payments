 ...
 * present and different from MLFA (MailToFinalAgent), CRFA
 * (CourierToFinalAgent), RGFA (RegisteredMailToFinalAgent) or PUFA
 * (PickUpByFinalAgent), then CreditTransferTransactionInformation/CreditorAgent
 * is not allowed.
 */
public class ConstraintChequeDeliveryAndNoCreditorAgentRule {
