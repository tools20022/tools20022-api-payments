...
/**
 * If ISIN is not present then either Description or at least one occurrence of
 * OtherIdentification must be present.
 */
public class ConstraintISINPresenceRule {
	...
	/**
	 * If ISIN is not present then either Description or at least one occurrence
