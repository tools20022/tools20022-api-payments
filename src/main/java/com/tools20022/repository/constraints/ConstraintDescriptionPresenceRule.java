...
/**
 * If Description is not present then either ISIN or at least one occurrence of
 * OtherIdentification must be present.
 */
public class ConstraintDescriptionPresenceRule {
	...
	/**
	 * If Description is not present then either ISIN or at least one occurrence
	 * of OtherIdentification must be present.
	 */
