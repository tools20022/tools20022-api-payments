...
public class ConstraintTotalInterbankSettlementAmountAndDateRule {
	 ...
	 * </ul>
	 */
	public static final MMConstraint forGroupHeader50 = new MMConstraint() {
		{
		...
		public void executeValidator(Object obj) throws Exception {
			checkGroupHeader50((GroupHeader50) obj);
		}
	};
	/**
	 * 
	 ...
	 * </ul>
	 */
	public static final MMConstraint forGroupHeader70 = new MMConstraint() {
		{
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "TotalInterbankSettlementAmountAndDateRule";
			definition = "If TotalInterbankSettlementAmount is present, then InterbankSettlementDate must be present.";
		...
		@Override
		public void executeValidator(Object obj) throws Exception {
			checkGroupHeader70((GroupHeader70) obj);
		}
	};
	/**
	 * 
