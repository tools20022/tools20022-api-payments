 ...
 * PDNG, then TransactionInformationAndStatus/TransactionStatus must be
 * different from RJCT.
 */
public class ConstraintGroupAndTransactionStatus2Rule {
	 ...
	 * name} = "GroupAndTransactionStatus2Rule"</li>
	 * <li>
