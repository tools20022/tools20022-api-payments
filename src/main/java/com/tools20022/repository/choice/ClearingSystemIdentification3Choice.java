...
public class ClearingSystemIdentification3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ClearingSystemIdentification3Choice.mmCode, ClearingSystemIdentification3Choice.mmProprietary);
	...
	public void setCode(ExternalCashClearingSystem1Code code) {
		this.code = code;
	}
