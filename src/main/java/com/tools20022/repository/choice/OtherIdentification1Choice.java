...
import com.tools20022.repository.codeset.PersonIdentificationType5Code;
...
@XmlType(name = "OtherIdentification1Choice", propOrder = {"code", "proprietary"})
public class OtherIdentification1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected PersonIdentificationType5Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * definition} = "Other identification expressed as a code."</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<OtherIdentification1Choice, PersonIdentificationType5Code> mmCode = new MMMessageAttribute<OtherIdentification1Choice, PersonIdentificationType5Code>() {
		{
			...
			name = "Code";
			definition = "Other identification expressed as a code.";
			maxOccurs = 1;
			minOccurs = 1;
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "Other identification expressed as a proprietary code."</li>
	 * </ul>
	 */
	public static final MMMessageAttribute<OtherIdentification1Choice, GenericIdentification47> mmProprietary = new MMMessageAttribute<OtherIdentification1Choice, GenericIdentification47>() {
		{
			...
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Proprietary";
			definition = "Other identification expressed as a proprietary code.";
			maxOccurs = 1;
			minOccurs = 1;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OtherIdentification1Choice.mmCode, com.tools20022.repository.choice.OtherIdentification1Choice.mmProprietary);
				trace_lazy = () -> GenericIdentification.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OtherIdentification1Choice";
	...
	public PersonIdentificationType5Code getCode() {
		return code;
	}

	public OtherIdentification1Choice setCode(PersonIdentificationType5Code code) {
	...
	public OtherIdentification1Choice setProprietary(GenericIdentification47 proprietary) {
