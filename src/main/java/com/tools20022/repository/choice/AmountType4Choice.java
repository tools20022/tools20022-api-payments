...
@XmlType(name = "AmountType4Choice", propOrder = {"instructedAmount", "equivalentAmount"})
public class AmountType4Choice {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.choice.AmountType4Choice
	 * AmountType4Choice}</li>
	...
	public static final MMMessageAttribute mmInstructedAmount = new MMMessageAttribute() {
		{
			...
			previousVersion_lazy = () -> AmountType3Choice.mmInstructedAmount;
			maxOccurs = 1;
			minOccurs = 1;
	...
	public static final MMMessageAssociationEnd mmEquivalentAmount = new MMMessageAssociationEnd() {
		{
			...
			previousVersion_lazy = () -> AmountType3Choice.mmEquivalentAmount;
			maxOccurs = 1;
			minOccurs = 1;
			isComposite = true;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AmountType4Choice.mmInstructedAmount, com.tools20022.repository.choice.AmountType4Choice.mmEquivalentAmount);
				...
				previousVersion_lazy = () -> AmountType3Choice.mmObject();
			}
		});
	...
	public AmountType4Choice setInstructedAmount(ActiveOrHistoricCurrencyAndAmount instructedAmount) {
	...
	public AmountType4Choice setEquivalentAmount(EquivalentAmount2 equivalentAmount) {
