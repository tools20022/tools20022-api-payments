 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.MandateStatus1Choice#mmCode
 ...
 * definition} = "Sets of elements to identify the status of a mandate."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "MandateStatus1Choice", propOrder = {"code", "proprietary"})
public class MandateStatus1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExternalMandateStatus1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * simpleType} =
	 * {@linkplain com.tools20022.repository.codeset.ExternalMandateStatus1Code
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MandateStatus1Choice.mmCode, com.tools20022.repository.choice.MandateStatus1Choice.mmProprietary);
	...
	public ExternalMandateStatus1Code getCode() {
		return code;
	}

	public MandateStatus1Choice setCode(ExternalMandateStatus1Code code) {
	...
	public MandateStatus1Choice setProprietary(Max35Text proprietary) {
