...
public class TransactionPrice4Choice {
	 ...
	 * complexType} = {@linkplain com.tools20022.repository.msg.Price7 Price7}</li>
	 * <li>
	...
	public static final MMMessageAttribute<TransactionPrice4Choice, Price7> mmDealPrice = new MMMessageAttribute<TransactionPrice4Choice, Price7>() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.choice.TransactionPrice4Choice.mmObject();
			isDerived = false;
			xmlTag = "DealPric";
			...
			maxOccurs = 1;
			minOccurs = 1;
			complexType_lazy = () -> Price7.mmObject();
		}
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.TransactionPrice4Choice.mmDealPrice, com.tools20022.repository.choice.TransactionPrice4Choice.mmProprietary);
