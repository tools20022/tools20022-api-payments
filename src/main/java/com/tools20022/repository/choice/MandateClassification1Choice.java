...
@XmlType(name = "MandateClassification1Choice", propOrder = {"code", "proprietary"})
public class MandateClassification1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected MandateClassification1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.MandateClassification1Choice.mmCode, com.tools20022.repository.choice.MandateClassification1Choice.mmProprietary);
	...
	public MandateClassification1Code getCode() {
		return code;
	}

	public MandateClassification1Choice setCode(MandateClassification1Code code) {
	...
	public MandateClassification1Choice setProprietary(Max35Text proprietary) {
