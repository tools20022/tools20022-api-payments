...
public class MandateClassification1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(MandateClassification1Choice.mmCode, MandateClassification1Choice.mmProprietary);
	...
	public void setCode(MandateClassification1Code code) {
		this.code = code;
	}
