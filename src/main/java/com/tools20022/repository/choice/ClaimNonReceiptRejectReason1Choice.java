...
import com.tools20022.repository.codeset.ExternalClaimNonReceiptRejection1Code;
 ...
 * definition} = "Specifies the rejection reason of a claim non receipt."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "ClaimNonReceiptRejectReason1Choice", propOrder = {"code", "proprietary"})
public class ClaimNonReceiptRejectReason1Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected ExternalClaimNonReceiptRejection1Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ClaimNonReceiptRejectReason1Choice.mmCode, com.tools20022.repository.choice.ClaimNonReceiptRejectReason1Choice.mmProprietary);
				trace_lazy = () -> InvestigationCaseStatus.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ClaimNonReceiptRejectReason1Choice";
				definition = "Specifies the rejection reason of a claim non receipt.";
			}
		});
		return mmObject_lazy.get();
	}

	public ExternalClaimNonReceiptRejection1Code getCode() {
		return code;
	}

	public ClaimNonReceiptRejectReason1Choice setCode(ExternalClaimNonReceiptRejection1Code code) {
	...
	public ClaimNonReceiptRejectReason1Choice setProprietary(Max35Text proprietary) {
