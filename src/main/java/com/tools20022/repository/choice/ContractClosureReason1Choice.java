...
public class ContractClosureReason1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ContractClosureReason1Choice.mmCode, com.tools20022.repository.choice.ContractClosureReason1Choice.mmProprietary);
	...
	public ContractClosureReason1Choice setCode(ExternalContractClosureReason1Code code) {
	...
	public ContractClosureReason1Choice setProprietary(Max35Text proprietary) {
