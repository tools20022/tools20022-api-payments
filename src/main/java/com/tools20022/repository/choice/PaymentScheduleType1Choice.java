...
import com.tools20022.repository.codeset.PaymentScheduleType1Code;
 ...
 * definition} = "Choice for payment schedule type."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "PaymentScheduleType1Choice", propOrder = {"code", "proprietary"})
public class PaymentScheduleType1Choice {
	...
	public PaymentScheduleType1Choice setCode(PaymentScheduleType1Code code) {
	...
	public PaymentScheduleType1Choice setProprietary(Max35Text proprietary) {
