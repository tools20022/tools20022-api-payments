...
public class BalanceSubType1Choice {
	...
	public static final MMMessageAttribute<BalanceSubType1Choice, ExternalBalanceSubType1Code> mmCode = new MMMessageAttribute<BalanceSubType1Choice, ExternalBalanceSubType1Code>() {
		{
			...
			componentContext_lazy = () -> com.tools20022.repository.choice.BalanceSubType1Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.BalanceSubType1Choice.mmCode, com.tools20022.repository.choice.BalanceSubType1Choice.mmProprietary);
